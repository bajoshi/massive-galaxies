...
if __name__ == '__main__':
    ...
    for i in range(len(color_cut_idx_gn1)):
        ...
        if not np.isfinite(f105_125_color):
            ...
            final_obj_figsid.append(gn1cat['id'][color_cut_idx_gn1[i]])
            final_obj_ra.append(gn1cat['ra'][color_cut_idx_gn1[i]])
            final_obj_dec.append(gn1cat['dec'][color_cut_idx_gn1[i]])
            final_obj_f160w_mag.append(gn1_f160w_mag[color_cut_idx_gn1[i]])
            final_obj_105_125_color.append(f105_125_color)
    ...
    for i in range(len(color_cut_idx_gn2)):
        ...
        if not np.isfinite(f105_125_color):
            ...
            final_obj_figsid.append(gn2cat['id'][color_cut_idx_gn2[i]])
            final_obj_ra.append(gn2cat['ra'][color_cut_idx_gn2[i]])
            final_obj_dec.append(gn2cat['dec'][color_cut_idx_gn2[i]])
            final_obj_f160w_mag.append(gn2_f160w_mag[color_cut_idx_gn2[i]])
            final_obj_105_125_color.append(f105_125_color)
    ...
    ax.plot(gn1_f160w_mag, gn1_f105w_mag - gn1_f125w_mag, 'o', color='k', markersize=2)
    ax.scatter(gn1_f160w_mag[color_cut_idx_gn1], gn1_f105w_mag[color_cut_idx_gn1] - gn1_f125w_mag[color_cut_idx_gn1], s=50, edgecolors='r', facecolor='None')
    ...
    ax.plot(gn2_f160w_mag, gn2_f105w_mag - gn2_f125w_mag, 'o', color='k', markersize=2)
    ax.scatter(gn2_f160w_mag[color_cut_idx_gn2], gn2_f105w_mag[color_cut_idx_gn2] - gn2_f125w_mag[color_cut_idx_gn2], s=50, edgecolors='r', facecolor='None')
