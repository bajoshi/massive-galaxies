...
def do_fitting(flam_obs, ferr_obs, lam_obs, lsf, starting_z, resampling_lam_grid, \
    ...
    obj_id, obj_field, specz, search_range):
    ...
    plot_fit_and_residual_withinfo(lam_obs, flam_obs, ferr_obs, best_fit_model_in_objlamgrid, bestalpha,\
        obj_id, obj_field, specz, z_grism, low_z_lim, upper_z_lim, min_chi2_red, age, tau, (tauv/1.086))
    """
...
def plot_fit_and_residual_withinfo(lam_obs, flam_obs, ferr_obs, best_fit_model_in_objlamgrid, bestalpha,\
    ...
    fig.savefig(figs_dir + 'massive-galaxies-figures/new_specz_sample_fits/' + \
        obj_field + '_' + str(obj_id) + '_broadlsf_linemask.png', \
...
if __name__ == '__main__':
    ...
    for cat in all_speccats:
        ...
        for i in range(len(cat)):
            ...
            # D4000 check # accept only if D4000 greater than 1.1
            # get d4000
            ...
            do_fitting(flam_obs, ferr_obs, lam_obs, broad_lsf, starting_z, resampling_lam_grid, \
                ...
                current_id, current_field, current_specz, 0.2)
    ...
    np.save(figs_dir + 'massive-galaxies-figures/new_specz_sample_fits/zgrism_lowerr_list.npy', zgrism_lowerr_list)
    np.save(figs_dir + 'massive-galaxies-figures/new_specz_sample_fits/zgrism_uperr_list.npy', zgrism_uperr_list)
    ...
    np.save(figs_dir + 'massive-galaxies-figures/new_specz_sample_fits/d4000_list.npy', d4000_list)
    np.save(figs_dir + 'massive-galaxies-figures/new_specz_sample_fits/d4000_err_list.npy', d4000_err_list)
